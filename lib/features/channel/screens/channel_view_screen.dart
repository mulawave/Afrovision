  ...
  Future<void> _deleteChannel() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Text('Disable Channel',
            style: TextStyle(color: AppColors.white)),
        content: const Text('This channel will be disabled and hidden.',
            ...
            child: Column(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: NetworkImage('${AppConfig.baseUrl}${ch.bannerUrl}'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: ch.logoUrl == null
                      ...
                      : null,
                  border: Border.all(
                      color: AppColors.orange.withValues(alpha: 0.4), width: 2),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(
                      ch.isPrivate ? Icons.lock_rounded : Icons.public_rounded,
                      color: ch.isPrivate
                          ? AppColors.errorRed
              ...
              _buildInfoCard(
                ...
                trailing: GestureDetector(
                  onTap: () {
                    Clipboard.setData(
                        ClipboardData(text: ch.channelNumber));
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
              ...
              _buildInfoCard(
                ...
                valueColor: ch.isPrivate ? AppColors.hintText : null,
              ),
              _buildInfoCard(
