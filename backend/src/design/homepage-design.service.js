...
const UPDATE_DEFAULTS = [
  {
    ...
    body: 'We are excited to announce the launch of Premium Streams on AfroVision! This new feature allows creators to offer exclusive, ad-free content to their subscribers. Premium subscribers gain access to special streams, behind-the-scenes content, and creator-only perks such as custom badges and emotes. Creators can set their own subscription prices and keep a significant portion of the revenue. This monetization option empowers our creators to build sustainable businesses while giving viewers an enhanced viewing experience. Premium streams are marked with a special badge and are only accessible to subscribers. Join the premium experience today and support your favorite creators!',
date: 'Mar 28, 2026',
    icon: '⭐',
    tag: 'New Feature',
  },
  {
    ...
    body: 'AfroVision now supports creator subscriptions, allowing viewers to support their favorite creators through monthly recurring payments. Subscribers unlock exclusive benefits including custom badges, special emotes, access to subscriber-only streams, and direct interaction with creators. Creators can set their subscription prices and manage their subscriber base through a comprehensive dashboard. This feature creates a sustainable income stream for creators while building stronger communities around their content. Subscription tiers can be customized to offer different levels of access and perks, giving creators flexibility in how they engage with their audience.',
date: 'Mar 15, 2026',
    icon: '💎',
    tag: 'Monetization',
  },
  {
    ...
    body: 'Our real-time gifting system has received a major upgrade! Viewers can now send animated gifts during live streams with stunning visual effects. New gift tiers have been added, ranging from small tokens of appreciation to grand gestures that trigger special on-screen celebrations. Each gift comes with unique animations and sound effects that enhance the streaming experience for everyone. Creators can customize gift reactions and set up special alerts for different gift levels. The gifting system now includes leaderboards, achievement badges for top gifters, and seasonal exclusive gifts. This makes every stream more interactive and rewarding for both creators and viewers.',
date: 'Mar 02, 2026',
    icon: '🎁',
    tag: 'Enhancement',
  },
  {
    ...
    body: 'The VPT (Vision Point Token) wallet is now fully integrated across the AfroVision platform. Users can earn VPT tokens through various activities including watching streams, participating in challenges, referring friends, and engaging with content. These tokens can be spent on premium subscriptions, gifts, exclusive content, and special platform features. The wallet provides instant transfers with zero transaction fees, real-time balance updates, and detailed transaction history. Users can also purchase VPT tokens directly through the app. The wallet system includes security features like two-factor authentication and spending limits to protect user funds. This creates a complete economy within the AfroVision ecosystem.',
date: 'Feb 18, 2026',
    icon: '💰',
    tag: 'Economy',
  },
  {
    ...
    body: 'AfroVision is now truly pan-African with comprehensive multi-language support. The platform now supports Swahili, Yoruba, Hausa, Zulu, French, and Portuguese alongside English. Users can switch between languages instantly, with all interface elements, notifications, and content descriptions translated accurately. The streaming experience includes subtitles and closed captions in multiple languages for accessibility. Content creators can tag their streams with language preferences, helping viewers discover content in their preferred language. The chat system also supports multiple languages with real-time translation features. This expansion makes AfroVision accessible to millions more users across the African continent and the diaspora, fostering greater cultural exchange and community building.',
date: 'Feb 05, 2026',
    icon: '🌐',
    tag: 'Platform',
  },
  {
    ...
    body: 'Streaming quality on AfroVision has been significantly enhanced with adaptive bitrate technology. Viewers can now enjoy streams in up to 4K resolution, with the platform automatically adjusting quality based on network conditions for smooth playback. The new streaming infrastructure delivers lower latency, enabling real-time interactions between creators and viewers with minimal delay. Enhanced audio quality supports spatial audio and high-fidelity sound for music streams. The system includes advanced error correction and buffering optimization to prevent interruptions. Mobile users benefit from optimized streaming that conserves data while maintaining quality. These improvements ensure that every stream delivers the best possible viewing experience regardless of device or network conditions.',
date: 'Jan 20, 2026',
    icon: '📺',
    tag: 'Performance',
  },
...
function normalizeUpdates(items, defaults) {
  ...
  return withOrder(source.map((item, index) => ({
    ...
    body: sanitizeText(item?.body, '', 5000),
