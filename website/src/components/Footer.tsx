  ...
  return (
    <footer className="bg-av-dark-blue border-t border-av-input-border/20">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-16">
              ...
              <div className="flex gap-3">
                {socialLinks.map((s) => (
                  <a
                    ...
                    aria-label={s.label}
                    className="w-9 h-9 rounded-lg bg-av-card border border-av-input-border/30 flex items-center justify-center text-av-hint hover:text-av-orange hover:border-av-orange/40 transition-all"
                  >
              ...
              <ul className="space-y-2.5">
                {links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-sm text-av-hint hover:text-av-white transition-colors"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        {/* Bottom bar */}
        <div className="mt-12 pt-8 border-t border-av-input-border/20 flex flex-col sm:flex-row items-center justify-between gap-4">
